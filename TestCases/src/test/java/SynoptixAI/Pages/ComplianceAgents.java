...
public class ComplianceAgents {
	...
	private By agentCategory=By.xpath("//span[normalize-space()='Legal' or normalize-space()='All Teams']");
	private By complianceCategory=By.xpath("//button[contains(text(),'Compliance')]");
	private By riskDetectAgent=By.xpath("(//button[contains(text(),'Try Now')])[1]");
	private By trainingAgent=By.xpath("(//button[contains(text(),'Try Now')])[2]");
	private By thirdPartyAgent=By.xpath("(//button[contains(text(),'Try Now')])[3]");
	...
	public void checkRiskDetector() throws InterruptedException 
	{
		...
		wait.until(ExpectedConditions.elementToBeClickable(complianceCategory)).click();

		Thread.sleep(2000);

		// Click Code Debug Agent
		wait.until(ExpectedConditions.elementToBeClickable(riskDetectAgent)).click();
	...
	public void checkTrainingAgent() throws InterruptedException 
	{
		...
		Thread.sleep(1500);
		wait.until(ExpectedConditions.elementToBeClickable(trainingAgent)).click();
	...
	public void checkThirdPartyAgent() throws InterruptedException 
	{
		...
		Thread.sleep(1500);
		wait.until(ExpectedConditions.elementToBeClickable(thirdPartyAgent)).click();
