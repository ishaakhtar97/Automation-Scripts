...
public class SignUp {
	...
	protected By profileMenu = By.xpath("//div[contains(@class,'rounded-full') and contains(@class,'cursor-pointer')]");
	private By createAccountBtn = By.xpath("//button[normalize-space()='Create an Account']");
	protected By loginBtn = By.xpath("//button[normalize-space()='Log in']");
	...
	private By closeBtn = By.xpath("(//button[contains(@class,'top-3') and contains(@class,'right-3')])[last()]");
	...
	public void waitForEmailVerification() throws InterruptedException {
	    System.out.println("Please verify email manually. Waiting for 1 minute...");
	    Thread.sleep(60000);
	}
}
