...
public class FinanceAgents {
	...
	private By agentCategory=By.xpath("//span[normalize-space()='IT Operations' or normalize-space()='All Teams']");
	private By financeCategory=By.xpath("//button[contains(text(),'Finance')]");
	private By financeEOMAccrualsAgent=By.xpath("(//button[contains(text(),'Try Now')])[1]");
	private By financeManagementGuideAgent=By.xpath("(//button[contains(text(),'Try Now')])[2]"); 
	private By financeReportAgent=By.xpath("(//button[contains(text(),'Try Now')])[3]");
	private By accountingDocAgent=By.xpath("(//button[contains(text(),'Try Now')])[4]");
	private By forecastingAgent=By.xpath("(//button[contains(text(),'Try Now')])[5]");
	private By financialAnamolyAgent=By.xpath("(//button[contains(text(),'Try Now')])[6]");
	...
	public void checkEOMAccruals() throws InterruptedException 
	{
		...
		wait.until(ExpectedConditions.elementToBeClickable(financeCategory)).click();

		Thread.sleep(2000);

		// Click Code Debug Agent
		wait.until(ExpectedConditions.elementToBeClickable(financeEOMAccrualsAgent)).click();
	...
	public void checkFinanceManagement() throws InterruptedException 
	{
		...
		Thread.sleep(1500);
		wait.until(ExpectedConditions.elementToBeClickable(financeManagementGuideAgent)).click();
	...
	public void checkFinanceReport() throws InterruptedException 
	{
		...
		Thread.sleep(1500);
		wait.until(ExpectedConditions.elementToBeClickable(financeReportAgent)).click();
	...
	public void checkAccountingDoc() throws InterruptedException 
	{
		...
		Thread.sleep(1500);
		wait.until(ExpectedConditions.elementToBeClickable(accountingDocAgent)).click();
	...
	public void checkForecastingAgent() throws InterruptedException 
	{
		...
		Thread.sleep(1500);
		wait.until(ExpectedConditions.elementToBeClickable(forecastingAgent)).click();
	...
	public void checkAnamolyDetectorAgent() throws InterruptedException 
	{
		...
		Thread.sleep(1500);
		wait.until(ExpectedConditions.elementToBeClickable(financialAnamolyAgent)).click();
