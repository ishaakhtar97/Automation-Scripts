...
public class HRAgents {
	...
	private By agentCategory=By.xpath("//span[normalize-space()='Compliance' or normalize-space()='All Teams']");
	private By hRCategory=By.xpath("//button[contains(text(),'HR')]");
	private By candidateSearchAgent=By.xpath("(//button[contains(text(),'Try Now')])[1]");
	private By offerLetterAgent=By.xpath("(//button[contains(text(),'Try Now')])[2]");
	private By helpDeskAgent=By.xpath("(//button[contains(text(),'Try Now')])[3]");
	private By benefitsAgent=By.xpath("(//button[contains(text(),'Try Now')])[4]");
	...
	public void checkCandidateSearch() throws InterruptedException 
	{
		...
		wait.until(ExpectedConditions.elementToBeClickable(hRCategory)).click();

		Thread.sleep(2000);

		// Click Code Debug Agent
		wait.until(ExpectedConditions.elementToBeClickable(candidateSearchAgent)).click();
	...
	public void checkOfferLetter() throws InterruptedException 
	{
		...
		Thread.sleep(1500);
		wait.until(ExpectedConditions.elementToBeClickable(offerLetterAgent)).click();
	...
	public void checkBenefits() throws InterruptedException 
	{
		...
		Thread.sleep(1500);
		wait.until(ExpectedConditions.elementToBeClickable(benefitsAgent)).click();
