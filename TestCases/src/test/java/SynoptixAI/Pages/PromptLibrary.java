...
public class PromptLibrary {
	...
	WebDriver driver;
	WebDriverWait wait;
	private By backToSearch=By.xpath("//span[normalize-space()='Search']");
	...
	private By promptName=By.xpath("//input[@name='name']");
	...
	private By info=By.xpath("//textarea[@name='prompt']");
	private By createPrompt=By.xpath("(//button[normalize-space()='Create New Prompt'])[last()]");
	...
	{
		wait.until(ExpectedConditions.elementToBeClickable(backToSearch)).click();
