...
public class ProjectManagementAgents {
	...
	private By agentCategory=By.xpath("//span[normalize-space()='HR' or normalize-space()='All Teams']");
	private By pMOCategory=By.xpath("//button[contains(text(),'Project Management')]");
	private By generateTaskAgent=By.xpath("(//button[contains(text(),'Try Now')])[1]");
	private By resourcePlanningAgent=By.xpath("(//button[contains(text(),'Try Now')])[2]");
	private By riskAssessmentAgent=By.xpath("(//button[contains(text(),'Try Now')])[3]");
	private By riskMitigationAgent=By.xpath("(//button[contains(text(),'Try Now')])[4]");
	private By summariseProjectAgent=By.xpath("(//button[contains(text(),'Try Now')])[5]");
	...
	public void checkGenerateTask() throws InterruptedException 
	{
		...
		wait.until(ExpectedConditions.elementToBeClickable(pMOCategory)).click();

		Thread.sleep(2000);

		// Click Code Debug Agent
		wait.until(ExpectedConditions.elementToBeClickable(generateTaskAgent)).click();
	...
	public void checkResourcePlanning() throws InterruptedException 
	{
		...
		Thread.sleep(1500);
		wait.until(ExpectedConditions.elementToBeClickable(resourcePlanningAgent)).click();
	...
	public void checkRiskAssessment() throws InterruptedException 
	{
		...
		Thread.sleep(1500);
		wait.until(ExpectedConditions.elementToBeClickable(riskAssessmentAgent)).click();
	...
	public void checkRiskMitigation() throws InterruptedException 
	{
		...
		Thread.sleep(1500);
		wait.until(ExpectedConditions.elementToBeClickable(riskMitigationAgent)).click();
	...
	public void checkSummariseProjectAgent() throws InterruptedException 
	{
		...
		Thread.sleep(1500);
		wait.until(ExpectedConditions.elementToBeClickable(summariseProjectAgent)).click();
