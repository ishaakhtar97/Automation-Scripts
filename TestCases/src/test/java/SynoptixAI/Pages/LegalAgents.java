...
public class LegalAgents {
	...
	private By reviewLegalAgent=By.xpath("(//button[contains(text(),'Try Now')])[3]");
	private By extractLegalAgent=By.xpath("(//button[contains(text(),'Try Now')])[4]");
	...
	public void checkLegalStrategy() throws InterruptedException 
	{
		...
		wait.until(ExpectedConditions.elementToBeClickable(legalCategory)).click();

		Thread.sleep(2000);

		// Click Code Debug Agent
		wait.until(ExpectedConditions.elementToBeClickable(legalStrategyAgent)).click();
	...
	public void checkQuickerLegal() throws InterruptedException 
	{
		...
		Thread.sleep(1500);
		wait.until(ExpectedConditions.elementToBeClickable(quickLegalAgent)).click();
	...
	public void checkReviewLegal() throws InterruptedException 
	{
		...
		Thread.sleep(1500);
		wait.until(ExpectedConditions.elementToBeClickable(reviewLegalAgent)).click();
	...
	public void checkExtractLegal() throws InterruptedException 
	{
		...
		Thread.sleep(1500);
		wait.until(ExpectedConditions.elementToBeClickable(extractLegalAgent)).click();
